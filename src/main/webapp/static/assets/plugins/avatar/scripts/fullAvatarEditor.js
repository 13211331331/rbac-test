function fullAvatarEditor() {
	...
	var file			= window.basePath + 'static/assets/plugins/avatar/fullAvatarEditor.swf';		//flash文件的路径
	var	version			= "10.1.0";						//播放该flash所需的最低版本
	//var	expressInstall	= 'expressInstall.swf';			//expressInstall.swf的路径
	var	expressInstall	= window.basePath + 'static/assets/plugins/avatar/expressInstall.swf';			//expressInstall.swf的路径
