...
var Page = function() {
    return {
        ...
        listPage : function(curPage,flag) {
            ...
            var remote_url = window.basePath + "rbac/user/totalpage";
            $.post(remote_url, params, function(data) {
                ...
                remote_url = window.basePath + "rbac/user/list";
                $.post(remote_url, params, function(data) {
        ...
        doManage : function(id,action) {
            var remote_url;
            if(action == "reuse"){
                remote_url = window.basePath + "rbac/user/status";
                var params = {
                    id : id,
                    status:1
                };
                ...
                remote_url = window.basePath + "rbac/user/detail/" +id;
